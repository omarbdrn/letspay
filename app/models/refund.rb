...
class Refund < Operation

  def self.create_from_mango_params_and_share_id!(mango_params, share_id)
    Refund.create!(bind_mango_params_to_attributes(mango_params).merge(traceable_type: 'Share', traceable_id: share_id))
  end

  def self.create_from_mango_params_and_purchase_id!(mango_params, purchase_id)
    Refund.create!(bind_mango_params_to_attributes(mango_params).merge(traceable_type: 'Purchase', traceable_id: purchase_id))
  end
  ...
  def self.bind_mango_params_to_attributes(mango_params)
    {
      ...
      initial_transaction_mango_id: mango_params['InitialTransactionId'],
      initial_transaction_type:     mango_params['InitialTransactionType'],
